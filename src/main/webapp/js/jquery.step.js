...
(function (factory) {
    ...
    if (typeof define === 'function') {
      ...
      define.cmd&&define('jquery-step', ['src/main/webapp/js/common'], function (require, exports, moudles) {
            var $=require("src/main/webapp/js/common");
            factory($);
            return $;
        });
      define.amd&&define(['src/main/webapp/js/common'], factory);
    } else {
